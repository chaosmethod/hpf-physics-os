...
This repository contains the active HPF framework canon together with the current Lambda / dark-matter package, support notes, executable evidence, and archive material.

The current working state is the **no-1.4 active Lambda canon**. In this repo state:

- the corrected radial law is active: `R_H / L_vac = φ^n`
- no `/2` belongs in the active radial identity
- the active Lambda branch is  
  `1.05 -> 1.3806 -> 5.7889 -> n = 220 -> L_vac -> Λ`
- the dark-matter branch remains separate:  
...
This README is meant to keep the public repo usable without reopening retired branches or mixing authority levels.
...
### 2. Serious-reader technical draft
- `HPF_Lambda_DarkMatter_Canonical_2026-03-29_final_reader_pass_no14canon_with_selector_robustness.md`

This is the current reader-facing technical draft for serious mathematical review.
...
### 4. Package handoff / repo navigation
- `HPF_Lambda_DarkMatter_Consolidated_Active_Master_Package_2026-03-29_no14canon_v2.md`
- `HPF_Lambda_DM_active_package_manifest_2026-03-29_no14canon_v2.md`

These are the current package-level navigation and authority-map files.

### 5. Anti-drift control
- `Symbol_index_2026-03-29_rewritten_v3_no14.md`
- `volume-3-provenance-map-updated_v2_no14.md`

These files should be used to prevent symbol drift and authority drift.

---

## Framework canon files

These remain part of the broader HPF / QPRCA working canon:
...
## Current active Lambda / dark-matter branches
...
The active package now includes local robustness results for the shell selector.

Current package-level status:
...
- no uniqueness theorem claimed from this result alone
- no substrate-class universality theorem claimed from this result alone

The correct strength statement is:

> Within the scanned local neighborhood, the active shell selector is dominated by the macroscopic interval budget and is largely insensitive to gate steepness, while the shell-conversion prefactor remains the stiffest direction.

This means the active selector does **not** currently look like a narrow `k = 11` gate-shape fine-tuning artifact. It does **not** yet prove uniqueness or universality across admissible substrate classes.
...
- use of `1.4` as an active operational canon value in the Lambda branch

Historical files may still contain those elements. Treat them as archived unless explicitly rewritten into the no-1.4 authority set.
...
### Quick serious-reader handoff
1. `HPF_Lambda_DarkMatter_Canonical_2026-03-29_final_reader_pass_no14canon_with_selector_robustness.md`
2. `HPF_Lambda_DarkMatter_attackable_core_2026-03-29_no14canon.md`
3. `Symbol_index_2026-03-29_rewritten_v3_no14.md`

### Package/navigation handoff
1. `HPF_Lambda_DarkMatter_Consolidated_Active_Master_Package_2026-03-29_no14canon_v2.md`
2. `HPF_Lambda_DM_active_package_manifest_2026-03-29_no14canon_v2.md`
...
2. then the **final reader pass with selector robustness**
3. then the **attackable core no14**
4. then the **v2 package / v2 manifest**
5. then the **symbol index / provenance map**
6. then support notes and executable evidence
7. archived files lose unless explicitly re-promoted
...
- `HPF_Lambda_DarkMatter_Consolidated_Active_Master_Package_2026-03-29_no14canon.md`
- older pre-no14 canon files
- older symbol index revisions
- older provenance-map revisions
- temporary figure drafts and retired image-generation outputs
...
- the active vacuum-sector Lambda / dark-matter package
...
- the archive boundary needed to keep retired branches from re-entering active canon by accident

---

## Current status in one paragraph

The repo currently presents HPF as a regulatory framework with MDEA routing and QPRCA substrate authority, together with an active candidate-locked vacuum-sector package in which the corrected no-`/2` radial law, the active entropy-phase selector, the separated dark-matter governor-transfer branch, and the local selector-robustness result are all preserved under explicit truth-status discipline. The current working repo state is the no-1.4 Lambda canon, with support and executable artifacts retained but demoted below primary canon authority.
