...
`HPF_Lambda_DarkMatter_Canonical_2026-03-29_final_reader_pass_no14canon_with_selector_robustness.md` is the current serious-reader derivation document for the vacuum sector, now updated with the selector local robustness result.
...
8. `HPF_Lambda_DarkMatter_Canonical_2026-03-29_final_reader_pass_no14canon_with_selector_robustness.md` — full reader-facing vacuum-sector paper
